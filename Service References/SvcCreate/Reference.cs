...
namespace SiriusSVCcall.SvcCreate {
    ...
    public partial class PatientExistsException : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private SiriusSVCcall.SvcCreate.Patient[] ExistingPatientsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public SiriusSVCcall.SvcCreate.Patient[] ExistingPatients {
            get {
    ...
    [System.SerializableAttribute()]
    public partial class Patient : SiriusSVCcall.SvcCreate.Auditable {
    ...
    [System.SerializableAttribute()]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(SiriusSVCcall.SvcCreate.Patient))]
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:schemas-csoitalia-it:pcreatesvc-v10", ConfigurationName="SvcCreate.IHttpCreate")]
    public interface IHttpCreate {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.UnconfiguredWebServiceException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IPCreateSvc/CreatePatientUnconfiguredWebS" +
            "erviceExceptionFault", Name="UnconfiguredWebServiceException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.PatientExistsException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IPCreateSvc/CreatePatientPatientExistsExc" +
            "eptionFault", Name="PatientExistsException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.InvalidParameterException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IPCreateSvc/CreatePatientInvalidParameter" +
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.PatientNotFoundException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IPCreateSvc/ScheduleProcedurePatientNotFo" +
            "undExceptionFault", Name="PatientNotFoundException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.UnconfiguredWebServiceException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IPCreateSvc/ScheduleProcedureUnconfigured" +
            "WebServiceExceptionFault", Name="UnconfiguredWebServiceException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.InvalidParameterException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IPCreateSvc/ScheduleProcedureInvalidParam" +
            "eterExceptionFault", Name="InvalidParameterException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        void ScheduleProcedure(string PatientId, System.DateTime StudyDate, string AccessionNumber, string ReferringPhysician);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.UnconfiguredWebServiceException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IPCreateSvc/AddRefractionUnconfiguredWebS" +
            "erviceExceptionFault", Name="UnconfiguredWebServiceException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.NoStudyFoundException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IPCreateSvc/AddRefractionNoStudyFoundExce" +
            "ptionFault", Name="NoStudyFoundException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.RefractionException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IPCreateSvc/AddRefractionRefractionExcept" +
            "ionFault", Name="RefractionException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.PatientNotFoundException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IPCreateSvc/AddRefractionPatientNotFoundE" +
            "xceptionFault", Name="PatientNotFoundException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.InvalidParameterException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IPCreateSvc/AddRefractionInvalidParameter" +
            "ExceptionFault", Name="InvalidParameterException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        ...
        // CODEGEN: Der Nachrichtenvertrag wird generiert, da der Vorgang AddReport weder in RPC noch in einem Dokument eingeschlossen ist.
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.InvalidParameterException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IHttpCreate/AddReportInvalidParameterExce" +
            "ptionFault", Name="InvalidParameterException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.StudyNotFoundException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IHttpCreate/AddReportStudyNotFoundExcepti" +
            "onFault", Name="StudyNotFoundException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.PdfException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IHttpCreate/AddReportPdfExceptionFault", Name="PdfException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        [System.ServiceModel.FaultContractAttribute(typeof(SiriusSVCcall.SvcCreate.UnconfiguredWebServiceException), Action="urn:schemas-csoitalia-it:pcreatesvc-v10/IHttpCreate/AddReportUnconfiguredWebServi" +
            "ceExceptionFault", Name="UnconfiguredWebServiceException", Namespace="urn:schemas-csoitalia-it:phoenix-dt-v10")]
        SiriusSVCcall.SvcCreate.AddReportResponse AddReport(SiriusSVCcall.SvcCreate.ReportMessage request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IHttpCreateChannel : SiriusSVCcall.SvcCreate.IHttpCreate, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class HttpCreateClient : System.ServiceModel.ClientBase<SiriusSVCcall.SvcCreate.IHttpCreate>, SiriusSVCcall.SvcCreate.IHttpCreate {
        ...
        public void ScheduleProcedure(string PatientId, System.DateTime StudyDate, string AccessionNumber, string ReferringPhysician) {
            base.Channel.ScheduleProcedure(PatientId, StudyDate, AccessionNumber, ReferringPhysician);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SiriusSVCcall.SvcCreate.AddReportResponse SiriusSVCcall.SvcCreate.IHttpCreate.AddReport(SiriusSVCcall.SvcCreate.ReportMessage request) {
            return base.Channel.AddReport(request);
        }
        
        public void AddReport(string StudyId, string Title, System.IO.Stream Pdf) {
            SiriusSVCcall.SvcCreate.ReportMessage inValue = new SiriusSVCcall.SvcCreate.ReportMessage();
            inValue.StudyId = StudyId;
            inValue.Title = Title;
            inValue.Pdf = Pdf;
            SiriusSVCcall.SvcCreate.AddReportResponse retVal = ((SiriusSVCcall.SvcCreate.IHttpCreate)(this)).AddReport(inValue);
        }
    }
}
